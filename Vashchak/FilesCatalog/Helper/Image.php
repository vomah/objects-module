...
namespace Vashchak\FilesCatalog\Helper;
...
use Vashchak\FilesCatalog\Model\ImageFactory;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Vashchak\FilesCatalog\Model\Image
     */
    protected $model;
     ...
     * image factory
     *
     * @var \Vashchak\FilesCatalog\Model\ImageFactory
     */
    ...
    public function init($entity, $imageId, $attributes = [])
    {
        ...
        $this->attributes = array_merge(
            $this->getConfigView()->getMediaAttributes('Vashchak_FilesCatalog', self::MEDIA_TYPE_CONFIG_NODE, $imageId),
            $attributes
        );
     ...
     *
     * @see \Vashchak\FilesCatalog\Model\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
     ...
     *
     * @see \Vashchak\FilesCatalog\Model\Image\Image
    ...
    {
        if ($placeholder) {
            $placeholderFullPath = 'Vashchak_FilesCatalog::images/'.$this->entityCode.'/placeholder/' . $placeholder . '.jpg';
        } else {
            $placeholderFullPath = $this->placeholder
                ?: 'Vashchak_FilesCatalog::images/'.$this->entityCode.'/placeholder/' . $this->getModel()->getDestinationSubdir() . '.jpg';
        }
     ...
     *
     * @return \Vashchak\FilesCatalog\Model\Image
     */
    protected function getModel()
    {
        if (!$this->model) {
            $this->model = $this->imageFactory->create(['entityCode' => 'object']);
        }
        return $this->model;
    }
    ...
    public function getFrame()
    {
        ...
        if (empty($frame)) {
            $frame = $this->getConfigView()->getVarValue('Vashchak_FilesCatalog', 'image_white_borders');
        }
        return $frame;
    }
